    ...
    <div style={{ position: 'fixed', bottom: 28, right: 28, zIndex: 200 }}>
      {hover && (
        <div style={{
          ...
          background: '#0A1F44', color: 'white', fontSize: '0.82rem',
          whiteSpace: 'nowrap', padding: '8px 14px', borderRadius: 8,
          fontFamily: "'DM Sans',sans-serif",
          boxShadow: '0 4px 16px rgba(10,31,68,0.25)',
        }}>
          Chat with us on WhatsApp
        </div>
      )}
      <a
        href="https://wa.me/254799644100?text=Hi%20Neurospark%20Corporation%21%20I%27d%20like%20to%20learn%20more%20about%20your%20AI%20agents."
        target="_blank"
        rel="noreferrer"
